...
BULLET_HIT_SOUND =pygame.mixer.Sound(os.path.join("Asserts","Grenade+1.mp3"))
BULLET_FIRE_SOUND =pygame.mixer.Sound(os.path.join("Asserts","Gun+Silencer.mp3"))
...
YELLOW_SPACESHIP_IMAGE =pygame.image.load(os.path.join("Asserts","spaceship_yellow.png"))
YELLOW_SPACESHIP =pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH,SPACESHIP_HEIGHT)),90)

RED_SPACESHIP_IMAGE =pygame.image.load(os.path.join("Asserts","spaceship_red.png"))
RED_SPACESHIP =pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMAGE,(SPACESHIP_WIDTH,SPACESHIP_HEIGHT)),270)

SPACE =pygame.transform.scale(pygame.image.load(os.path.join("Asserts","space.png")),(WIDTH,HEIGHT))

pygame.display.set_caption("Astro Battle")
